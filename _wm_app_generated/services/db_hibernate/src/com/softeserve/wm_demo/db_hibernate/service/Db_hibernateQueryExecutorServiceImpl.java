...
@Service
public class Db_hibernateQueryExecutorServiceImpl implements Db_hibernateQueryExecutorService {

    private static final Logger LOGGER = LoggerFactory.getLogger(Db_hibernateQueryExecutorServiceImpl.class);

    @Autowired
    @Qualifier("db_hibernateWMQueryExecutor")
