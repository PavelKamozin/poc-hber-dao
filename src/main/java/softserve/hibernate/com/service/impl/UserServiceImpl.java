...
public class UserServiceImpl implements UserService {
    ...
    public User partialUpdate(Integer usersId, User user) {
        ...
        try {
            ObjectReader usersReader = this.objectMapper.reader().forType(User.class).withValueToUpdate(users);
            users = usersReader.readValue(this.objectMapper.writeValueAsString(user));
        } catch (IOException ex) {
            LOGGER.debug("There was a problem in applying the patch: {}", user, ex);
